...
function getDB() {
    ...
    if ($count == 0) {
        $initial = [
            ...
            ['Manali Snow Adventure', 'Himachal Pradesh', '5D/4N', '₹16,999', 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&w=800&q=80', 'domestic', '[{"day": 1, "title": "Arrival", "activities": "Check-in..."}, {"day": 2, "title": "Solang Valley", "activities": "Snow sports..."}]'],
